    ...
    // <a href="#" id="simClickElement" class="beta-warning">BETA WARNING</a>
	  ...
	  <div class="loader"></div>
		...
		<div class="list-block media-list">
				...
				<li>
					<a href="" class="already-istalled open-popover link item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/Google/google.png" width="80">
						</div>
			...
			<ul>-->
				<li>
					<a href="http://ichanger.tk/uriref.php?a=Google&p=maximal.png&n=Google&ur=googleapp://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/Google/maximal.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
