	  ...
	  <div class="loader"></div>
        <div class="navbar">
          <div class="navbar-inner">
            ...
            <div class="center sliding">iChanger 2 - Phone</div>
		...
		<div class="content-block-title">Phone Icons</div>
				...
				<li>
					<a href="" class="already-istalled open-popover link item-link item-content">
						...
						<div class="item-inner">
							...
							<div class="item-text">Apple's Default Phone Icon. This icon is here to show you the side by side comparison</div>
						</div>
					</a>
				</li>
