    ...
    // <a href="#" id="simClickElement" class="beta-warning">BETA WARNING</a>
	  ...
	  <div class="loader"></div>
		...
		<div class="list-block media-list">
				...
				<li>
					<a href="" class="already-istalled open-popover link item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/Messages/Messages.ico" width="80">
						</div>
			...
			<ul>-->
				<li>
					<a href="http://ichanger.tk/uriref.php?a=Messages&p=maximal1.png&n=Messages&ur=sms://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/Messages/maximal1.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
			...
			<ul>-->
				<li>
					<a href="http://ichanger.tk/uriref.php?a=Messages&p=maximal2.png&n=Messages&ur=sms://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/Messages/maximal2.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
            ...
            <ul>-->
				...
				<li>
					<a href="http://ichanger.tk/uriref.php?a=Messages&p=novusfull.png&n=Messages&ur=sms://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/Messages/novus.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
