		...
		<div class="list-block media-list">
				...
				<li>
					<a href="" class="already-istalled open-popover link item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/Mail/Mail.ico" width="80">
						</div>
						<div class="item-inner">
							...
							<div class="item-text">Apple's Default Mail Icon. This icon is here to show you the side by side comparison</div>
						</div>
					</a>
				</li>
			...
			<ul>-->
				<li>
					<a href="http://ichangerapp.com/uriref.php?a=Mail&p=maximal.png&n=Mail&ur=mailto://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/Mail/maximal.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
			...
			<ul>-->
				<li>
					<a href="http://ichangerapp.com/uriref.php?a=Mail&p=novusfull.png&n=Mail&ur=mailto://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/Mail/novus.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
