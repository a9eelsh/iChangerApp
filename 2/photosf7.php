	  ...
	  <div class="loader"></div>
        <div class="navbar">
          <div class="navbar-inner">
            ...
            <div class="center sliding">iChanger 2 - Photos</div>
		...
		<div class="content-block-title">Photos Icons</div>
		<div class="list-block media-list">
			<ul>
				<li>
					<a href="" class="already-istalled open-popover link item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/pics/photos.jpg" width="80">
						</div>
						<div class="item-inner">
							...
							<div class="item-text">Apple's Default Photos Icon. This icon is here to show you the side by side comparison</div>
						</div>
					</a>
				</li>
			...
			<ul>-->
				<li>
					<a href="http://ichangerapp.com/uriref.php?a=Photos&p=maximal.png&n=Photos&ur=photos-redirect://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/Photos/maximal.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
			...
			<ul>-->
				<li>
					<a href="http://ichangerapp.com/uriref.php?a=Photos&p=flattest.png&n=Photos&ur=photos-redirect://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/Photos/flattest.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
            ...
            <ul>-->
				...
				<li>
					<a href="http://ichangerapp.com/uriref.php?a=Photos&p=gcons.png&n=Photos&ur=photos-redirect://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/Photos/gcons.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
