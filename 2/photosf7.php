    ...
    // <a href="#" id="simClickElement" class="beta-warning">BETA WARNING</a>
	  ...
	  <div class="loader"></div>
		...
		<div class="list-block media-list">
				...
				<li>
					<a href="" class="already-istalled open-popover link item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/pics/photos.png" width="80">
						</div>
			...
			<ul>-->
				<li>
					<a href="http://ichanger.tk/uriref.php?a=Photos&p=flattest.png&n=Photos&ur=photos-redirect://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/Photos/flattest.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
