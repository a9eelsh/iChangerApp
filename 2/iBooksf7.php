        <div class="navbar">
          <div class="navbar-inner">
            ...
            <div class="center sliding">iBooks</div>
		...
		<div class="list-block media-list">
				...
				<li>
					<a href="" class="already-istalled open-popover link item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/iBooks/AppStoreDefault.png" width="80">
						</div>
			...
			<ul>-->
				<li>
					<a href="http://ichangerapp.com/uriref.php?a=iBooks&p=ib-magic.jpg&n=iBooks&ur=itms-books://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/iBooks/ib-magic.jpg" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<div class="item-title">Magic iBook</div>
			...
			<ul>-->
				<li>
					<a href="http://ichangerapp.com/uriref.php?a=iBooks&p=ib-gem.png&n=iBooks&ur=itms-books://" class="external item-link item-content">
						<div class="item-media">
							<img src="http://ichangerapp.com/iBooks/ib-gem.png" width="80">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<div class="item-title">Orange Gem</div>
								<div class="item-after">Install</div>
							</div>
							<div class="item-subtitle">iBooks</div>
							<div class="item-text"></div>
				...
				<li>
					<a href="http://ichangerapp.com/uriref.php?a=AppStore&p=lightwinter.JPG&n=App%20Store&ur=itms-apps://itunes.apple.com" class="external item-link item-content">
						...
						<div class="item-inner">
							...
							<div class="item-subtitle">ibooks</div>
							<div class="item-text">A Light Winter Themed ibooks</div>
						</div>
					</a>
				</li>
