	  ...
	  <div class="loader"></div>
		...
		<div class="list-block media-list">
				...
				<li>
					<a href="" class="already-istalled open-popover link item-link item-content">
						<div class="item-media">
							<img src="http://ichanger.tk/GPlus/GPlus.png" width="80">
						</div>
			...
			<ul> %2B = + | Google%2B = Google+ -->
				<li>
					<a href="http://ichanger.tk/uriref.php?a=GPlus&p=maximal.png&n=Google%2B&ur=gplus://" class="external item-link item-content">
						<div class="item-media">
			...
			<ul>-->
				<li>
					<a href="http://ichanger.tk/uriref.php?a=GPlus&p=LuminoSquare.png&n=Google%2B&ur=gplus://" class="external item-link item-content">
						<div class="item-media">
            ...
            <ul>-->
				...
				<li>
					<a href="http://ichanger.tk/uriref.php?a=GPlus&p=LuminoSquare2.png&n=Google%2B&ur=gplus://" class="external item-link item-content">
						<div class="item-media">
